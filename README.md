...
[![Gemma 4 E4B](https://img.shields.io/badge/Gemma_4-E4B-00C4B4?logo=google&logoColor=white)](https://ollama.com/library/gemma4)
...
[![Watch the demo](https://img.shields.io/badge/▶_Watch_Full_Demo-YouTube-FF0000?logo=youtube&logoColor=white&style=for-the-badge)](https://YOUR_YOUTUBE_LINK_HERE)
...
Two possible causes:
1. **Wrong model name** — run `ollama list` and update `GEMMA_MODEL` in `config.py` to match exactly.
2. **Old Ollama version** — the code automatically falls back to `/api/generate`. Update Ollama: `curl -fsSL https://ollama.com/install.sh | sh`
...
- [Google DeepMind](https://deepmind.google/) — Gemma 4 open weights
...
[github.com/quartzap/EchoGlow](https://github.com/quartzap/EchoGlow)
